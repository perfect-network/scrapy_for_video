import requests,json,time    #导入库
cid = "sdp001hm7cnjq96" #本次请求的专辑ID（电视剧ID）
file = open("text.txt", "w")    #打开文件
data = {'cid':cid}
tid =1
data =  json.dumps(data)
rep = requests.post( url="http://access.video.qq.com/tinyapp/video_detail?vappid=65939066&vsecret=07c58e0c93150c4254a2a24131574b94cab6142ba4210efa&vversion_name=5.2.0.1234&vplatform=3",data=data)
...
p = {"info":info,"link":link,"other":other}
# print(p)
print(p)
